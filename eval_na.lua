...
-- Data input settings
cmd:option('-input_img_test_json','data/vqa_raw_test.json','path to the json file containing the test information')
cmd:option('-input_json','data/vqa_data_prepro.json','path to the json file containing additional info and vocab')

cmd:option('-cnn_proto','image_model/VGG_ILSVRC_19_layers_deploy.prototxt','protofile for cnn model')
cmd:option('-cnn_model','image_model/VGG_ILSVRC_19_layers.caffemodel','cnn model')
...
local loader = DataLoaderEval{input_img_test_json=opt.input_img_test_json,input_json=opt.input_json,cnn_proto=opt.cnn_proto,cnn_model=opt.cnn_model,vqa_model=opt.start_from,batchsize=batch_size}
